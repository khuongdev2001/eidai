    ...
    <div class="header-social"
        ...
        <div class="header_soci" style="float:right; padding-right:0px;">
            <a href="https://www.facebook.com/sangonhatban/">
                <img src="http://eidai.com.vn/wp-content/uploads/2020/05/icons8-facebook-100.png" width="20px"
                     padding-bottom="-20px"> Facebook </a>
            <a href="https://www.youtube.com/channel/UCO6W7tJ1OP27-e99Yl4EDvg/">
                <img src="http://eidai.com.vn/wp-content/uploads/2020/05/icons8-youtube-64.png" width="20px"
                     margin-bottom="-20px"> Youtube </a>
        </div>
                ...
                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Thanh điều hướng chính">
                    ...
                    <img src="">
                            ...
                            <li id="menu-item-809"
                                ...
                                <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/">TẤT CẢ SẢN PHẨM</a>
                                <ul class="sub-menu">
                                    <li id="menu-item-20"
                                    ...
                                    <li id="menu-item-218"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-218">
                                        <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-tu-nhien-ky-thuat/">SÀN
                                            GỖ TỰ NHIÊN KỸ THUẬT</a>
                                    </li>
                                    <li id="menu-item-21"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-21">
                                        <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-olefin-ky-thuat/">SÀN
                                            GỖ OLEFIN KỸ THUẬT</a>
                                    </li>
                                    <li id="menu-item-22"
                                        class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-22">
                                        <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-lat-xuong-ca/">SÀN
                                            GỖ LÁT XƯƠNG CÁ</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li id="menu-item-243"
                                ...
                                <a class="menu-image-title-after menu-image-not-hovered">
                                    <img width="36" height="36"
                                         src="https://eidai.com.vn/wp-content/uploads/2020/05/icons8-menu-480-36x36.png"
                                         class="menu-image menu-image-title-after" alt="" loading="lazy"/>
                                    <span class="menu-image-title-after menu-image-title">
                    <b></b>
                  </span>
                            ...
                            <li id="menu-item-239"
                                class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-239">
                                <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-olefin-ky-thuat/">SÀN
                                    GỖ OLEFIN KỸ THUẬT</a>
                            </li>
                            <li id="menu-item-240"
                                class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-240">
                                <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-lat-xuong-ca/">SÀN
                                    GỖ LÁT XƯƠNG CÁ</a>
                            </li>
                            <li id="menu-item-241"
                                class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-241">
                                <a href="https://eidai.com.vn/product-category/du-an-tieu-bieu/">DỰ ÁN TIÊU BIỂU</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div id="woocommerce_product_search-2" class="widget woocommerce widget_product_search">
            <form role="search" method="get" class="woocommerce-product-search" action="https://eidai.com.vn/">
                ...
                <input type="search" id="woocommerce-product-search-field-1" class="search-field"
                       placeholder="Tìm sản phẩm&hellip;" value="" name="s"/>
