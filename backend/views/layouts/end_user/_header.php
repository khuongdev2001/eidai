                ...
                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Thanh điều hướng chính">
                    ...
                    <div class="primary-navigation">
                        <ul id="menu-menu-chinh" class="menu">
                            ...
                            <li id="menu-item-809" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-809">
                                <?php
                    ...
                    <div class="handheld-navigation">
                        <ul id="menu-menu-dien-thoai" class="menu">
                            ...
                            <li id="menu-item-237" class="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home menu-item-237">
                                <a href="http://eidai.com.vn" aria-current="page">TRANG CHỦ</a>
                            </li>
                            <li id="menu-item-242" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-242">
                            ...
                            <li id="menu-item-240" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-240">
                                <a href="https://eidai.com.vn/product-category/tat-ca-san-pham/san-go-lat-xuong-ca/">SÀN
                                    GỖ LÁT XƯƠNG CÁ</a>
                            </li>
                            <li id="menu-item-241" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-241">
                ...
                <ul id="site-header-cart" class="site-header-cart menu">
                    <li class="">
                        <a class="cart-contents" href="https://eidai.com.vn/cart/" title="Xem giỏ hàng của bạn">
                            <span class="woocommerce-Price-amount amount">0 <span class="woocommerce-Price-currencySymbol">&#8363;</span>
                            </span>
