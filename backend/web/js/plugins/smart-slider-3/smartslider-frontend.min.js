!function (t) {
    ...
    var s, n, h = t.document, o = h.documentElement, r = t.setTimeout, a = t.clearTimeout, u = i._N2,
        c = (t.requestAnimationFrame, function (t, i = null, s = null, n = null) {
        ...
        }), f = Object.assign, l = function (t, i) {
            ...
            return M(t, new CustomEvent(i, {bubbles: !1, cancelable: !1, detail: s}))
        }, z = function (t) {
            t.forEach((function (t) {
                t()
            })), t.splice(0, t.length)
            ...
            if (Math.abs(t.scrollTop - i) < 1) n && n(); else {
                s = Math.max(300, s || 300);
                var h = t.scrollTop, o = i - h, r = performance.now(), a = function (i) {
    ...
    B((function () {
        ...
        return t.prototype.preLoad = function (t) {
            ...
            if (this.lazyLoadNeighbor) for (var s = 0, n = t[0].getPrevious(), h = t[t.length - 1].getNext(); s < this.lazyLoadNeighbor;) n && (i.push(n.preLoad()), n = n.getPrevious()), h && (i.push(h.preLoad()), h = h.getNext()), s++;
            if (this.slider.stages.resolved("Visible")) for (var o = 0; o < i.length; o++) this.slider.U.addPromise(i[o]);
            return i
        }, t
        ...
        return s.prototype.start = function () {
            ...
            this.slider.stages.resolve("BeforeShow"), this.slider.widgets.onReady(), u.MW.N(function () {
                A(this.slider.responsive.alignElement, "n2-ss-align-visible"), A(this.slider.sliderElement, "n2-ss-loaded"), I(this.slider.sliderElement, "n2notransition"), requestAnimationFrame((function () {
                    F(i, "scroll")
                })), Y(this.slider.startVisibilityCheck.bind(this.slider), {timeout: 2e3})
        ...
        return {
            addPlugin: function (t, n) {
                ...
                if (h.plugins === n) for (var o in h.plugins = new t(h), i) h.plugins.add(o, i[o]);
                s.push(h)
            }
        }
        ...
        return t.prototype.add = function (t, s, n, h) {
            var r = {el: t, mode: s, onVisible: n, onHide: h, state: "unknown"};
            ...
            var s = t.el.getBoundingClientRect(), n = s.height > .7 * i, h = !0;
        ...
        t.prototype.makeReady = function (t, i) {
            if (this.sliders[t] = i, this.readys[t] !== n) for (var s = 0; s < this.readys[t].length; s++) this.readys[t][s].call(i, i, i.sliderElement)
            ...
            if (this.eventListeners[t] !== n) for (var s = this.eventListeners[t].length - 1; s >= 0; s--) this.eventListeners[t][s] === i && this.eventListeners[t].splice(s, 1)
        }, t.prototype.dispatch = function (t, i) {
            if (this.eventListeners[t] !== n && this.eventListeners[t].length) for (var s = this.eventListeners[t].length - 1; s >= 0; s--) this.eventListeners[t][s] && this.eventListeners[t][s].call(i, i)
        }, t.prototype.trigger = function (t, i, e) {
            e && e.preventDefault();
            var s = i.split(","), n = t.closest(".n2-ss-slide,.n2-ss-static-slide"), h = n.ssLastEvent;
            ...
            if (this.isClickAllowed(e)) {
                var i = e.currentTarget, s = this.findSliderByElement(i);
        ...
        var r = {
            focusOffsetTop: 0, to: function (t) {
                ...
                r.to(j(t) - i.innerHeight)
            }, after: function (t) {
                r.to(j(t) + E(t) - r.focusOffsetTop)
            }, next: function (t, i) {
                var s = h.querySelectorAll(i), n = -1;
                ...
                "string" == typeof t && (t = h.querySelector(t)), r.to(j(t) - r.focusOffsetTop)
            }
        };
        ...
        function t(h, o) {
            if (this.editor = null, this.elementID = h, i[h] && i[h] instanceof t) if (i[h].__sliderElement && !s.contains(i[h].__sliderElement)) ; else {
            ...
            this.stages = new u.Stages, u.d("#" + h, function () {
                return this
            }.bind(this)), this.isAdmin = !!o.admin, u.SmartSliderPlugins.addSlider(this), this.id = parseInt(h.replace("n2-ss-", "")), i[h] = this, o.isDelayed !== n && o.isDelayed ? B(function () {
        ...
        function l(t, s) {
            ...
            }.bind(this), {rootMargin: "200px 0px 200px 0px"}).observe(t); else if (c.push({
                element: t,
                callback: s
            }), 1 === c.length) {
                var n = [], h = function () {
                    for (var t = 1.4 * i.innerHeight, s = 0; s < c.length; s++) if (c[s].element.getBoundingClientRect().y < t) {
                        var o = c[s].callback;
                        c.splice(s, 1), s--, o()
                    }
                    0 === c.length && (z(n), u.SmartSliderApi.off("SliderResize", h))
                };
                n.push(L(i, "resize", h, {capture: !0})), n.push(L(i, "scroll", h, {
                    capture: !0,
                    passive: !0
        ...
        return t.prototype.onSliderExists = function (t, s, n) {
            if (this.__sliderElement = n, this.K = n.closest(".n2-section-smartslider"), this.U = this.K.querySelector("ss3-loader"), this.stages.resolve("Exists"), "TEMPLATE" === n.tagName) {
                var h = n.parentNode;
                h.removeChild(n);
                var o = m(n, "loadingType"), a = n.content.children[0], c = function () {
                    h.appendChild(a), k(this.K, "height"), this.waitForDimension(a, s), D(i, "n2Rocket", {sliderElement: a})
                }.bind(this);
            ...
            this.stages.resolve("HasDimension"), this.killed = !1, this.isVisible = !0, this.responsive = !1, this.mainAnimationLastChangeTime = 0, this.currentSlide = null, this.currentRealSlide = null, this.staticSlides = [], this.slides = [], this.visibleRealSlides = [], this.visibleSlides = [], t.ss = this, this.sliderElement = t, this.needBackgroundWrap = !1, this.blockCarousel = !1, this.parameters = f({
                ...
                maintainSession: 0,
                align: "normal",
                controls: {touch: "horizontal", keyboard: !1, mousewheel: !1, blockCarouselInteraction: 1},
                hardwareAcceleration: !0,
                layerMode: {playOnce: 0, playFirstLayer: 1, mode: "skippable", inAnimation: "mainInEnd"},
                parallax: {enabled: 0, mobile: 0, horizontal: "mouse", vertical: "mouse", origin: "enter"},
                mainanimation: {},
                ...
                postBackgroundAnimations: !1
            }, n2const.isSamsungBrowser && (this.disabled.layerSplitTextAnimations = !0, this.disabled.postBackgroundAnimations = !0, this.parameters.postBackgroundAnimations && I(this.sliderElement, "n2-ss-feature-post-bg-loader")), n2ss.makeReady(this.id, this), this.isAdmin && (this.changeTo = function () {
            }), this.load = new u.SmartSliderLoad(this), this.backgrounds = new u.SmartSliderBackgrounds(this), this.initSlides(), "function" == typeof this.parameters.initCallbacks && this.parameters.initCallbacks.call(this), this.stages.done("VisibleSlides", this.onSlidesReady.bind(this)), requestAnimationFrame(this.initUI.bind(this))
            ...
            if (this.responsive.parameters.focusUser && !t && (s = !0), s) {
                var n = _(), h = this.responsive.focusOffsetTop, o = this.responsive.focusOffsetBottom,
                    r = i.innerHeight, a = this.sliderElement.getBoundingClientRect(), u = a.top - h,
                    c = r - a.bottom - o, f = this.responsive.parameters.focusEdge, l = "";
            ...
            if ((t = parseInt(t)) !== this.currentSlide.index) {
                ...
                this.G("SlideWillChange", {targetSlide: this.slides[t]}), this.G("SlideLoading");
                ...
                return Promise.all([Promise.all(this.backgrounds.preLoadSlides(this.getVisibleSlides(this.slides[t]))), this.focus(s)]).then(function () {
                    if (t !== this.currentSlide.index) {
                        if (this.mainAnimationLastChangeTime < o) {
                            ...
                            }.bind(this), {once: !0}), this.mainAnimation.timeScale(2 * this.mainAnimation.timeScale()))
                        }
                        this.G("SlideLoaded")
                    }
                }.bind(this)), !0
        ...
        }, t.prototype._changeTo = function (t, i, s, n) {
        }, t.prototype.revertTo = function (t, i) {
            this.slides[i].unsetActive(), this.slides[t].setActive(), this._changeCurrentSlide(t), this.G("SlideWillChange", {targetSlide: this.slides[t]})
            ...
            var i;
            for (i = 0; i < this.realSlides.length; i++) if (this.realSlides[i].element.contains(t)) return this.realSlides[i];
            for (i = 0; i < this.staticSlides.length; i++) if (this.staticSlides[i].element.contains(t)) return this.staticSlides[i];
            return null
            ...
            for (var n = 0; n < this.realSlides.length; n++) if (+this.realSlides[n].id === t) return this.slide(this.getSlideIndex(n), i, s);
            var o = h.querySelector('[data-id="' + t + '"]');
            if (o && (o = o.closest(".n2-ss-slider")), o) return this.id === o.ss.id || (W(h.scrollingElement, j(o), 400), o.ss.slideToID(t, i, !0))
        ...
        return t.prototype.get = function (t) {
            ...
            var s;
            if ("string" == typeof t) s = this.get(t).getPromise(); else {
        ...
        return t.prototype.register = function (t, i) {
            ...
            var t = 0;
            if (this._verticals) for (var i = 0; i < this._verticals.length; i++) t += this._verticals[i].offsetHeight;
            return t
            ...
            var t = !1;
            for (var i in this.controls) if (this.controls[i] !== n) {
                var s = m(this.controls[i].widget, "excludeSlides");
                if (s !== n) {
                    for (var h = s.split(","), o = h.length - 1; o >= 0; o--) {
                        var r = h[o].split("-");
                        if (2 === r.length) {
                            var a = parseInt(r[0]), u = parseInt(r[1]);
                            if (a <= u) for (var c = a; c <= u; c++) h.push(c)
            ...
            if (t) {
                ...
                f({detail: {targetSlide: this.slider.currentRealSlide}}), O(this.slider.sliderElement, "SlideWillChange", f)
            }
            ...
            this.advancedElement && (m(this.advancedElement, "variables") || "").match(t) && this.flushAdvancedVariables()
        }, t
        ...
        function t(t, i) {
            this.state = "ended", this.isTouch = !1, this.isReverseAllowed = !0, this.isReverseEnabled = !1, this.reverseSlideIndex = null, this.isNoAnimation = !1, this.slider = t, this.parameters = f({
                duration: 1500,
                ease: "easeInOutQuint"
            }, i), this.parameters.duration = Math.max(.01, this.parameters.duration / 1e3), this.sliderElement = t.sliderElement, this.timeline = new u.q({paused: !0}), O(this.sliderElement, "mainAnimationStart", function (e) {
        ...
        return t.prototype.init = function () {
            ...
            this.isReverseEnabled = !0, this.reverseTimeline = new u.q({paused: !0}), D(this.slider.sliderElement, "reverseModeEnabled", {reverseSlideIndex: this.reverseSlideIndex})
            ...
            var n = t.totalDuration(), h = Math.max(n / 3, Math.min(n, s / Math.abs(i) / 1e3));
            ...
            this.state = "playing";
            var n = {mainAnimation: this, previousSlideIndex: t.index, currentSlideIndex: i.index, isSystem: s};
            ...
            }, this.timeline.clear(), this.timeline.timeScale(1)
        ...
        return t.prototype.getAnchor = function () {
            ...
            var t = this.getAnchor();
            if (t > 0) {
                var s = t - 1, n = i["n2-ss-" + this.st.id];
        ...
        return t.prototype.preventClickHandle = function () {
            ...
            this.rt = !0;
            this.timeline = u.W.to({_progress: 0}, this.getSlideDuration(this.slider.currentSlide.index), {
                _progress: 1,
                paused: !0,
            ...
            }.bind(this))), this.initClick(this.parameters.pause.click, this.parameters.resume.click), this.initHover(this.parameters.pause.mouse, this.parameters.resume.mouse), this.initMedia(this.parameters.pause.mediaStarted, this.parameters.resume.mediaEnded), this.slider.stages.resolve("AutoplayReady"), this.slider.G("autoplay", {progress: 0}), this.parameters.start || this.setState("pausedSecondary", 1), this.setState("paused", 0)
        }, t.prototype.setState = function (t, i) {
            ...
            this.timeline && this.timeline.eventCallback("onUpdate", function () {
                this.slider.G("autoplay", {progress: this.timeline.progress()})
            }.bind(this))
            ...
            var i = this.slider.realSlides[this.slider.getRealIndex(t)], s = i.minimumSlideDuration;
        ...
        function n() {
            this.controls = [], h.addEventListener("keydown", this.onKeyDown.bind(this)), h.addEventListener("mousemove", this.onMouseMove.bind(this), {capture: !0})
        }
        ...
        return n.prototype.onMouseMove = function (e) {
            ...
            if (e.target.tagName.match(/BODY|DIV|IMG/) && !e.target.isContentEditable) {
                var t;
                if (this.mouseEvent && (t = this.findSlider(h.elementFromPoint(this.mouseEvent.clientX, this.mouseEvent.clientY)))) return void D(t, "SliderKeyDown", {e: e});
                if (h.activeElement !== s && (t = this.findSlider(h.activeElement))) return void D(t, "SliderKeyDown", {e: e});
            ...
            var t = this.slider.sliderElement.getBoundingClientRect(), s = t.height / 2;
        ...
        function t(t, i) {
            this.preventScroll = {
                ...
                globalTimeout: !1
            }, this.maxDelta = 0, this.slider = t, this.ct = 2 === i ? "deltaX" : "deltaY", h.addEventListener("wheel", this.onGlobalMouseWheel.bind(this), {passive: !1}), t.controls.mouseWheel = this
        }
        ...
        return t.prototype.onStarterSlide = function () {
            ...
            if ("switch" === this.currentInteraction.action) {
                ...
                if (this.interactiveDrag) this._animation.timeline.progress() < 1 && this._animation.setTouchEnd(h, this.currentInteraction.progress, s.time), this._animation.setTouch(!1); else h && this.callAction(this.currentInteraction.animationStartDirection);
            ...
            if ("scroll" === this.currentInteraction.action && "pointer" === this.currentInteraction.type) {
                var t = this.currentInteraction.distanceY[0],
                    ...
                    s = (t.d - i.d) / (i.t - t.t) * 10, n = Date.now(), o = function () {
                        requestAnimationFrame(function () {
                            var t, i;
            ...
            if ("unknown" === this.currentInteraction.action && this.slider.visibleSlides.length > 1) if ("ended" === this._animation.state) {
        ...
        return t.prototype = Object.create(u.SmartSliderControlTouch.prototype), t.prototype.constructor = t, t.prototype.callAction = function (t, i) {
            ...
            var t = this.slider.currentSlide.index, i = t + 1 < this.slider.slides.length, s = t - 1 >= 0;
            this.slider.parameters.carousel && (i = !0, s = !0), n2const.isRTL() && "vertical" !== this.slider.getAnimationAxis() ? this.setState({
                right: i,
                left: s
            }, !0) : this.setState({right: s, left: i}, !0)
        ...
        function t() {
            this.state = {up: !1, down: !1}, this.action = {
                up: "next",
                down: "previous"
        ...
        return t.Strong = ["lightbox", "load"], t.prototype.add = function (t) {
            ...
            var t = !1;
            for (var i in this.waits) if (this.waits[i]) {
                t = !0;
                break
            }
        ...
        return t.prototype.getLoadPromise = function () {
            ...
            const t = m(this.imageElements[0].parentElement, "mode"), i = [];
            this.blur && i.push({
            ...
            u.W.to(u.MW.C(this.imageElements), .3, {opacity: 0})
        ...
        var t = {NOT_INITIALIZED: -1, INITIALIZED: 0, READY_TO_START: 1, PLAYING: 2, ENDED: 3, SUSPENDED: 4};
        ...
        return i.prototype = Object.create(u.FrontendPlacement.prototype), i.prototype.constructor = i, i.prototype.start = function () {
            ...
            this.vt = {width: t.offsetWidth, height: t.offsetHeight}
        }, i.prototype.onResizeSize = function () {
            var t = u.MW.k(this.layer.layer), i = this.bt.slideW, s = this.bt.slideH;
            this.isSingleAxis() && (s = i);
            var n = i, h = s;
            parseInt(this.layer.get("responsivesize")) || (n = h = 1);
            var o = this.getWidth(n), r = "number" == typeof o, a = this.getHeight(h), c = "number" == typeof a;
            ...
            var t = this.bt, i = this.layer.layer, s = u.MW.k(i), n = t.slideW, h = t.slideH;
            this.isSingleAxis() && (h = n), parseInt(this.layer.get("responsiveposition")) || (n = h = 1);
            var o = this.layer.getDevice("left") * n, r = this.layer.getDevice("top") * h,
                a = this.layer.getDevice("align"), c = this.layer.getDevice("valign");
            if (this.parentLayerPlacement && this.parentLayerPlacement.isVisible()) {
                var f = this.parentLayerPlacement.getPositionSize(), l = {left: 0, top: 0};
        ...
        function l(t, s) {
            for (var n in this.state = {StarterSlide: !1}, this.isVisible = !0, this.isResetActiveSlideEarly = this.isResetActiveSlideEarly || !1, this.focusOffsetTop = 0, this.focusOffsetBottom = 0, this.minimumSlideHeight = 0, this.at = !1, this.visibleRealSlidesChanged = !0, this.wt = -1, this.yt = -1, this.gt = -1, this.kt = -1, this.filters = {
                SliderWidth: [],
                SliderHeight: [],
                SlideHeight: [],
                SliderVerticalCSS: []
                ...
                breakpoints: [],
                sizes: {desktopPortrait: {width: 1200, height: 600, max: 1e4, min: 40}},
                ratioToDevice: {Portrait: {tablet: 0, mobile: 0}, Landscape: {tablet: 0, mobile: 0}},
        ...
        return h.addEventListener("scroll", (function () {
        ...
        }), {capture: !0, passive: !0}), l.DeviceMode = {
            unknown: 0,
            desktoplandscape: 1,
            desktopportrait: 2,
            tabletlandscape: 3,
            ...
            if (this.slider.stages.done("ResizeFirst", function () {
                ...
                slideW: 1,
                slideH: 1
            }, this.horizontalSpacingControls = {right: [], left: []}, this.horizontalSpacing = {
                right: 0,
                left: 0
            }, this.staticSizes = {
                paddingTop: 0,
                ...
                var t = this.containerElement.parentNode, n = new ResizeObserver(function (t) {
            ...
            for (var t in this.mediaQueries) if (this.mediaQueries[t].matches) return l.DeviceMode[t];
            ...
            if ("" !== this.parameters.focus.offsetTop) {
                ...
                if (t && t.length) for (var i = new ResizeObserver(function (t) {
            ...
            y(this.sliderElement, "--subtract-vertical-offset", (i.n2OffsetTop || this.focusOffsetTop) + (i.n2OffsetBottom || this.focusOffsetBottom) + "px")
            ...
            if (this.slider.isVisible || this.visibleRealSlidesChanged) {
                for (var n = 0; n < this.slider.realSlides.length; n++) u.MW.k(this.slider.realSlides[n].element).setValues({
                    width: "",
                    height: ""
                }), g(this.slider.realSlides[n].element, {width: "", height: ""});
            ...
            this.visibleRealSlidesChanged && (this.visibleRealSlidesChanged = !1, this.isResetActiveSlideEarly || this.calibrateActiveSlide(), this.triggerVisibleSlidesChanged(), this.targetCurrentSlide !== n && (this.slider.G("SlideWillChange", {targetSlide: this.targetCurrentSlide}), this.slider.G("CurrentSlideChanged", {currentSlide: this.targetCurrentSlide}), this.slider.stages.resolved("Visible") && this.slider.playSlide(this.targetCurrentSlide), delete this.targetCurrentSlide))
            ...
            for (var i in this.horizontalSpacing = {
                right: 0,
                left: 0
            }, this.horizontalSpacingControls) for (var s = this.horizontalSpacingControls[i], n = s.length - 1; n >= 0; n--) {
                var h = s[n];
        ...
        function t(t, i, s, n, o, r) {
            if (this.state = {
                ...
                volume: "-1",
                dnt: "0"
            }, n), 1 === parseInt(this.parameters.autoplay)) if (navigator.userAgent.toLowerCase().indexOf("android") > -1) this.parameters.volume = 0; else if (n2const.isIOS) {
        ...
        return t.prototype.whenLoaded = function () {
            1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile ? this.ready(this.initVimeoPlayer.bind(this)) : this.ready(function () {
                ...
                }.bind(this), i = [L(this.playerElement, "click", t), L(this.playerElement, "n2click", t)]
            }.bind(this))
        }, t.prototype.ready = function (t) {
            ...
            t.className = "intrinsic-ignore", t.allow = "fullscreen; autoplay; encrypted-media", t.id = this.playerId + "-frame", t.src = "https://player.vimeo.com/video/" + this.parameters.vimeocode + "?autoplay=0&_video&title=" + this.parameters.title + "&byline=" + this.parameters.byline + "&background=" + this.parameters.background + "&portrait=" + this.parameters.portrait + "&color=" + this.parameters.color + "&loop=" + this.parameters.loop + ("-1" == this.parameters.quality ? "" : "&quality=" + this.parameters.quality) + "&dnt=" + this.parameters["privacy-enhanced"] + ("" !== this.parameters.privateid ? "&h=" + this.parameters.privateid : ""), t.webkitAllowFullScreen = !0, t.allowFullScreen = !0, g(t, {
                ...
                width: "100%",
                height: "100%"
            }), this.playerElement.prepend(t), this.player = new Vimeo.Player(t, {autoplay: !1}), this.promise = this.player.ready(), this.slider.stages.done("BeforeShow", function () {
            ...
            this.layer = i.layer, new ResizeObserver(function (t) {
                ...
                if (i.width && i.height) this.state.visible || this.setState("visible", !0, !0); else if (this.state.visible) {
                ...
                this.isStatic || D(this.slider.sliderElement, "mediaStarted", {id: this.playerId}), R(i, "n2play")
                ...
                this.isStatic || D(this.slider.sliderElement, "mediaEnded", {id: this.playerId}), R(i, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && 0 == this.parameters.loop && ((h.fullscreenElement || h.webkitFullscreenElement) && (h.exitFullscreen || h.webkitExitFullscreen).call(h), this.slider.next(!0))
            ...
            D(this.slider.sliderElement, "mediaStarted", {id: this.playerId}), 0 != this.start && this.safeSetCurrentTime(this.start), this.safePlay(), this.player.getCurrentTime().then(function (t) {
        ...
        var s;
        return t.prototype.whenLoaded = function () {
            if (1 === parseInt(this.parameters.autoplay) || !this.hasImage || n2const.isMobile) this.ready(this.initYoutubePlayer.bind(this)); else var t = function (e) {
            ...
            if (1 === parseInt(this.parameters.autoplay)) if (navigator.userAgent.toLowerCase().indexOf("android") > -1) this.parameters.volume = 0; else if (n2const.isIOS) {
                this.parameters.autoplay = 0;
                try {
            ...
            var o = {
                ...
                playerVars: s,
                events: {
                    onReady: this.onReady.bind(this), onStateChange: function (i) {
                        switch (i.data) {
                            case YT.PlayerState.PLAYING:
                            case YT.PlayerState.BUFFERING:
                                this.isStatic || this.slide.isActiveWhen(this.slider.currentSlide) && D(this.slider.sliderElement, "mediaStarted", {id: this.playerId}), R(t, "n2play");
                                break;
                            case YT.PlayerState.PAUSED:
                                R(t, "n2pause"), this.state.continuePlay ? (this.setState("continuePlay", !1), this.setState("play", !0)) : this.setState("play", !1);
                                break;
                            case YT.PlayerState.ENDED:
                                1 == this.parameters.loop ? (this.player.seekTo(this.parameters.start), this.player.playVideo()) : (this.isStatic || D(this.slider.sliderElement, "mediaEnded", {id: this.playerId}), R(t, "n2stop"), this.setState("play", !1), "next" === this.parameters.ended && ((h.fullscreenElement || h.webkitFullscreenElement) && (h.exitFullscreen || h.webkitExitFullscreen).call(h), this.slider.next(!0)))
                        }
                    }.bind(this)
                }
            };
            ...
            var t = this.playerElement.parentNode.getBoundingClientRect(), i = t.width, s = t.height + 100, n = 16 / 9,
                h = {width: i + "px", height: s + "px", "margin-top": 0};
            ...
            this.isStopped() && (this.coverFadedOut === n && r(this.fadeOutCover.bind(this), 200), D(this.slider.sliderElement, "mediaStarted", {id: this.playerId}), this.player.playVideo())
        }, t.prototype.pause = function () {
