!function (t) {
    ...
    var n, s, r = t.document, o = r.documentElement, h = t.setTimeout, a = t.clearTimeout, u = i._N2,
    ...
    x((function () {
        ...
        function a() {
            var t = performance.now(), n = r;
            r = [];
            for (var s = n.length - 1; s >= 0 && (n.pop().call(), !(performance.now() - t > 7)); s--) ;
            !i.n2Slow && n.length && (i.n2Slow = !0), n.unshift.apply(n, r), (r = n).length ? _(a, {timeout: 2e3}) : o = !1
        }
        ...
        function p(i, s, r) {
            var o = [];
            if (d(i) || n[i]) {
                if ("function" == typeof s ? (r = s, s = []) : "string" == typeof s && (s = [s]), (s = s || []).length) for (var h = 0; h < s.length; h++) d(s[h]), o.push(t[s[h]]);
        ...
        function m(i, n) {
            var r = [];
            if (n === s ? (n = i, i = []) : "string" == typeof i && (i = [i]), i = i || []) for (var o = 0; o < i.length; o++) d(i[o]), r.push(t[i[o]]);
        ...
        return i || (i = 250), function () {
            var r = this, o = +new Date, u = arguments;
        ...
        var s;
        return function () {
            var r = this, o = arguments, u = function () {
        ...
        if (x((function () {
            u.d("documentReady")
        })), "complete" === r.readyState) u.d("windowLoad"); else {
            let s;
        ...
        var t = function () {
                ...
                return function () {
                    ...
                    return Object.defineProperty(i.prototype, "size", {
                        ...
                        var n = t(this.__entries__, i), s = this.__entries__[n];
                        return s && s[1]
                        ...
                        var n = this.__entries__, s = t(n, i);
                        ~s && n.splice(s, 1)
        ...
        var c = 20, f = ["top", "right", "bottom", "left", "width", "height", "size", "weight"],
            l = "undefined" != typeof MutationObserver, v = function () {
                ...
                for (var n = 0, s = Object.keys(i); n < s.length; n++) {
                    var r = s[n];
                    Object.defineProperty(t, r, {value: i[r], enumerable: !1, writable: !1, configurable: !0})
                }
                return t
            }, p = function (t) {
        ...
        function M(t) {
            ...
            if (!i && !n) return m;
            var s = p(t).getComputedStyle(t), r = w(s), o = r.left + r.right, h = r.top + r.bottom, a = g(s.width),
                u = g(s.height);
            if ("border-box" === s.boxSizing && (Math.round(a + o) !== i && (a -= b(s, "left", "right") + o), Math.round(u + h) !== n && (u -= b(s, "top", "bottom") + h)), !_(t)) {
                var c = Math.round(a + o) - i, f = Math.round(u + h) - n;
        ...
        function O(t) {
            var i = t.x, n = t.y, s = t.width, r = t.height,
                o = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, h = Object.create(o.prototype);
            return d(h, {x: i, y: n, width: s, height: r, top: n, right: i + s, bottom: r + n, left: i}), h
        }
        ...
        }(), C = "undefined" != typeof WeakMap ? new WeakMap : new t, D = function () {
            function t(i) {
                if (!(this instanceof t)) throw new TypeError("Cannot call a class as a function.");
                if (!arguments.length) throw new TypeError("1 argument required, but only 0 present.");
                var n = v.getInstance(), s = new A(i, n, this);
                C.set(this, s)
            }
        ...
        connectedCallback() {
            if (this.isConnected) {
                ...
                var s = n;
                if (i.ssForceFullHorizontalSelector) s = i.ssForceFullHorizontalSelector; else {
                ...
                if (s === n) for (var a = [".elementor-section-stretched", '.siteorigin-panels-stretch[data-stretch-type="full-stretched"]', '.siteorigin-panels-stretch[data-stretch-type="full-stretched-padded"]', ".themify_builder_row.fullwidth", '.vce-row[data-vce-stretch-content="true"]'], c = 0; c < a.length; c++) {
    ...
    i.n2const = {
        ...
        r.prototype.addTimeout = function (t) {
            ...
            for (var t = 0; t < this.localListeners.length; t++) this.localListeners[t][0].removeEventListener(this.localListeners[t][1], this.localListeners[t][2], this.localListeners[t][3]);
            var i;
            this.isActive = !1, i = this.el, w(i, new Event("universalleave", {bubbles: !1, cancelable: !1}))
        ...
        return function (a, u) {
            var c = {preventDefault: !0, preventScroll: !1, mouse: !0, axis: "x", start: t, move: t, end: t, click: t};
            f(c, u);
            var l, v, d, p,
                m = {pointerEvents: !(n2const.isIOS && i.TouchEvent || !i.PointerEvent && !i.PointerEventsPolyfill)},
                g = {}, b = {}, w = [], x = !0, _ = m.pointerEvents ? 1 : 0,
                P = [["touchstart", "touchmove", "touchend", "touchcancel"], ["pointerdown", "pointermove", "pointerup", "pointercancel", "pointerleave"], ["mousedown", "mousemove", "mouseup", "", "mouseleave"]],
                O = [function (e) {
            ...
            function A(e, t) {
                if ((e.isPrimary === s || e.isPrimary) && !o && (l = [], x = !0, !O[p = t](e) && !k(e.target))) if (("mousedown" === e.type || "pointerdown" === e.type && "mouse" === e.pointerType) && e.target.closest(".n2-ss-text")) {
                    ...
                    passive: !1,
                    capture: !0
                })), l.push(M(r, P[p][2], R, {passive: !1, capture: !0})), l.push(M(r, P[p][3], R, {
                    passive: !1,
                    capture: !0
                })), l.push(M(n, P[p][4], D, {passive: !1, capture: !0})), g = {
                    x: p ? e.clientX : e.touches[0].clientX,
                    y: p ? e.clientY : e.touches[0].clientY,
                    time: Date.now()
                }, v = s, d = !1, b = {x: 0, y: 0}, c.start(e, g), C(e)
            }
            ...
            return w.push(M(r, "scroll", (function () {
                ...
                A(e, _)
            }), {passive: !1, capture: !0})), 0 === _ && w.push(M(a, P[0][1], (function (e) {
                C(e)
            }), {
                passive: !1,
                capture: !0
                ...
                supportsPointerEvents: m.pointerEvents, getClicksAllowed: function () {
                    return x
                }, kill: function () {
        ...
        var t, n = !1, s = -1, r = new Set, o = new Set, a = i.requestAnimationFrame || (t = 0, function (i) {
            var n = (new Date).getTime(), s = Math.max(0, 16 - (n - t));
        ...
        function f(t) {
            if (n && 0 === r.size && 0 === o.size) s = -1, n = !1; else if (-1 !== s) {
                var i = (t - s) / 1e3;
        ...
        return t.prototype.initParameters = function () {
            ...
            return arguments.length > 3 ? this._eventCallbacks[t] = [arguments[1], arguments[2], arguments[3]] : arguments.length > 2 ? this._eventCallbacks[t] = [arguments[1], arguments[2], this] : arguments.length > 1 && (this._eventCallbacks[t] = [arguments[1], [], this]), this._eventCallbacks[t]
            ...
            if (this._progress < 1) if (0 == this._progress && t && this._delay > 0) {
            ...
            } else this.__play(); else this._isCompleted || (this._isReversed ? this._onReverseComplete() : this._onComplete())
        ...
        function r(s, r) {
            ...
            if (n(s) || (s = [s]), this._target = s, this.fromParams = o, u.Animation.call(this, h), this.parseParameters({duration: r}), this._mode === t && this._immediateRender) {
        ...
        return t.prototype = Object.create(u.Animation.prototype), t.prototype.constructor = t, t.prototype._onUpdate = function () {
            if (this.tweensContainer) for (var t = 0; t < this.tweensContainer.length; t++) {
            ...
            if (0 == this._progress) for (var t = 0; t < this._tweens.length; t++) this._tweens[t].pause(0);
            ...
            for (var i = 0; i < this._tweens.length; i++) {
                var n = this._tweens[i], s = n.startTime() / t, r = (n.startTime() + n.totalDuration()) / t;
                this.tweensContainer.push({tween: n, startProgress: s, endProgress: r, range: r - s})
            }
        }, u.q = t, t
