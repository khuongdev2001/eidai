...
function priceSlider() {
    jQuery(function (_) {
        ...
        }), e(), _(document.body).on("init_price_filter", e), "undefined" != typeof wp && wp.customize && wp.customize.selectiveRefresh && wp.customize.widgetsPreview && wp.customize.widgetsPreview.WidgetPartial && wp.customize.selectiveRefresh.bind("partial-content-rendered", function () {
            e()
        })
    });
}
